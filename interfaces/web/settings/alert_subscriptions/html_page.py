...
def _build_head(*, css_href: str) -> str:
    return (
        ...
        '<title>Alert Subscriptions</title>'
...
def _build_body(*, model_endpoint: str, save_endpoint: str, js_src: str) -> str:
    return (
        '<div id="alert-subscriptions-app"></div>'
        f'<script>window.__ALERT_SUBSCRIPTIONS__={{"modelEndpoint":"{model_endpoint}","saveEndpoint":"{save_endpoint}"}};</script>'
