...
class StaticController:
    ...
    def get_css(self) -> HttpResponse:
        body = read_text_asset(
            root=self._root,
            relative_path="interfaces/web/settings/messaging_preferences/static/channel_preferences.css",
        )
        return HttpResponse(
            status_code=200,
    ...
    def get_js(self) -> HttpResponse:
        body = read_text_asset(
            root=self._root,
            relative_path="interfaces/web/settings/messaging_preferences/static/channel_preferences.js",
        )
        return HttpResponse(
            status_code=200,
