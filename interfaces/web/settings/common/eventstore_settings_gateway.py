...
class EventStoreSettingsGateway:
    ...
    def set_value(self, *, tenant_id: str, key: str, value):
        self._service.set(tenant_id=str(tenant_id), key=str(key), value=value)
    def compare_and_set_value(self, *, tenant_id: str, key: str, expected, value) -> bool:
        return bool(self._service.compare_and_set(tenant_id=str(tenant_id), key=str(key), expected=expected, value=value))
