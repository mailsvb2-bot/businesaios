...
def build_guarded_effects(*, effects_cls: Any, event_log: Any, policy_registry: Any, delivery_state: Any = None, ledger: Any = None, payment_outbox: Any = None, telegram_outbound_queue: Any = None, settings_gateway: Any = None, messaging_policy_event_store: Any = None, messaging_policy_read_service: Any = None, message_registry: Any = None, http_transport: Any = None, effect_router: Any = None, event_store: Any = None) -> tuple[str, EffectsPort]:
    cap = issue_capability()
    cap_token = cap.token
    raw: EffectsPort = effects_cls(
        event_log=event_log, policy_registry=policy_registry, event_store=event_store, delivery_state=delivery_state or _NoopDeliveryState(), ledger=ledger,
        ...
        message_registry=message_registry, http_transport=http_transport, effect_router=effect_router,
    )
