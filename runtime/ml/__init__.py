"""Canonical runtime package alias namespace for runtime.ml public API."""
...
_PUBLIC_ATTRS = {
    "MlScoringContext": ("core.ml.contracts", "MlScoringContext"),
    "MlService": ("core.ml.service", "MlService"),
}
