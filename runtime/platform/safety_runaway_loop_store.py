...
CANON_PLATFORM_SAFETY_RUNAWAY_LOOP_STORE = True
SCHEMA_VERSION = 2


class PlatformSqliteRunawayLoopStore:
    ...
    def _init_db(self) -> None:
        plan = SchemaMigrationPlan(
            component='runaway_loop_history',
...
__all__ = ['CANON_PLATFORM_SAFETY_RUNAWAY_LOOP_STORE', 'PlatformSqliteRunawayLoopStore', 'SCHEMA_VERSION']
