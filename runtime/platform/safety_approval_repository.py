...
class PlatformSqliteApprovalRepository:
    ...
    def _init_db(self) -> None:
        plan = SchemaMigrationPlan(
            component='approval_tickets',
            target_version=SCHEMA_VERSION,
            steps=(self._migrate_v1, self._migrate_v2, self._migrate_v3, self._migrate_v4, self._migrate_v5, self._migrate_v6),
        )
