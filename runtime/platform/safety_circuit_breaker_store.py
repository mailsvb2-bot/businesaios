...
class PlatformSqliteCircuitBreakerStore:
    ...
    def _init_db(self) -> None:
        plan = SchemaMigrationPlan(
            component='circuit_breaker_states',
...
__all__ = ['CANON_PLATFORM_SAFETY_CIRCUIT_BREAKER_STORE', 'PlatformSqliteCircuitBreakerStore', 'SCHEMA_VERSION']
