...
def handle_reward_observe(
    ...
    *,
    event_store: Any,
    reward_computer_cls: Any = RewardComputer,
    profit_metrics_service_cls: Any = ProfitMetricsService,
) -> Any:
    ...
    try:
        ...
        if existing is None:
            ...
            reward = reward_computer_cls(
                profit_metrics=profit_metrics_service_cls(event_store=event_store),
                window=RewardWindow(
