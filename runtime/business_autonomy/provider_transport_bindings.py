...
_BINDINGS: Mapping[str, Mapping[str, Any]] = {
    ...
    'vk_messaging': {'auth_scheme': 'vk_group_access_token', 'base_url': 'https://api.vk.com/method', 'probe_path': '/groups.getById', 'sync_path_family': '/{operation}', 'live_ready': True},
    'max_messaging': {'auth_scheme': 'authorization_token', 'base_url': 'https://platform-api2.max.ru', 'probe_path': '/me', 'sync_path_family': '/{operation}', 'live_ready': True},
