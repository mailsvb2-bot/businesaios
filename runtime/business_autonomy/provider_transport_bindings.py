...
_BINDINGS: Mapping[str, Mapping[str, Any]] = {
    ...
    'slack_messaging': {'auth_scheme': 'bearer_bot_token', 'base_url': 'https://slack.com/api', 'probe_path': '/auth.test', 'sync_path_family': '/{operation}', 'live_ready': False},
    'discord_messaging': {'auth_scheme': 'bot_token', 'base_url': 'https://discord.com/api/v10', 'probe_path': '/users/@me', 'sync_path_family': '/channels/{channel_id}/messages', 'live_ready': False},
