...
_BINDINGS: Mapping[str, Mapping[str, Any]] = {
    ...
    'sms_connector': {'auth_scheme': 'vendor_specific_credentials', 'base_url': 'vendor-configured', 'probe_path': '', 'sync_path_family': '', 'live_probe_ready': False, 'live_read_ready': False, 'live_write_ready': False, 'live_ready': False},
