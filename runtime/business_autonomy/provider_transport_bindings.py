...
_BINDINGS: Mapping[str, Mapping[str, Any]] = {
    ...
    'email_connector': {'auth_scheme': 'smtp_credentials', 'base_url': 'smtp://', 'probe_path': 'NOOP', 'sync_path_family': 'SMTP/{operation}', 'live_required_secrets': ('smtp_host', 'smtp_port', 'smtp_security', 'from_address'), 'live_endpoint_from_secret': True, 'live_probe_ready': True, 'live_read_ready': False, 'live_write_ready': True, 'live_ready': False},
    'sms_connector': {'auth_scheme': 'vendor_specific_credentials', 'base_url': 'vendor-configured', 'probe_path': '', 'sync_path_family': '', 'contract_only': True, 'live_probe_ready': False, 'live_read_ready': False, 'live_write_ready': False, 'live_ready': False},
