...
_BINDINGS: Mapping[str, Mapping[str, Any]] = {
    ...
    'hubspot': {'auth_scheme': 'bearer_token', 'base_url': 'https://api.hubapi.com', 'probe_path': '/crm/v3/objects/contacts', 'sync_path_family': '/crm/v3/{operation}', 'live_ready': True},
    ...
    'google_ads': {'auth_scheme': 'oauth_refresh_token', 'base_url': 'https://googleads.googleapis.com', 'probe_path': '/v16/customers:listAccessibleCustomers', 'sync_path_family': '/v16/{operation}', 'live_ready': False},
...
class ProviderTransportBindings:
    def describe(self, provider: ProviderDefinition) -> dict[str, Any]:
        base = dict(_BINDINGS.get(provider.provider_key) or {
...
__all__ = ['CANON_PROVIDER_TRANSPORT_BINDINGS', 'ProviderTransportBindings']
