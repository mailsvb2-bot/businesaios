...
class ProviderRuntimeWriteGuard:
    ...
    def evaluate(self, *, provider: ProviderDefinition, operation: str, mode: str, tenant_id: str = "", business_id: str = "", payload: Mapping[str, Any] | None = None, approval_completion_context: Mapping[str, Any] | None = None) -> ProviderRuntimeWriteGuardDecision:
        ...
        approval = self._approval_evidence(provider=provider, operation=normalized_operation, tenant_id=tenant_id, business_id=business_id, payload=payload, approval_completion_context=approval_completion_context)
