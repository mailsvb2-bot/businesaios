...
from interfaces.web.debug.messaging_policy_dashboard.flask_adapter import (
    register_flask_routes as _register_dashboard_routes,
)
from interfaces.web.debug.messaging_policy_observability_nav.flask_adapter import (
    register_flask_routes as _register_nav_routes,
)
from interfaces.web.debug.messaging_policy_snapshot.flask_adapter import (
    register_flask_routes as _register_snapshot_routes,
)
from interfaces.web.debug.messaging_policy_trace_search.flask_adapter import (
    register_flask_routes as _register_trace_routes,
)
from interfaces.web.settings.alert_subscriptions_integration.flask_adapter import (
    register_flask_routes as _register_alert_subscriptions_routes,
)
from interfaces.web.settings.messaging_preferences_integration.flask_adapter import (
    register_flask_routes as _register_preferences_routes,
)
