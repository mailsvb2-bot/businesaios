...
def growth_catalog() -> dict[str, CatalogEntry]:
    return {
        ...
        "growth_strategy_generate@v1": _entry("growth_strategy_generate@v1", 1, required={"tenant_id", "user_id"}, optional={"goal", "n", "model", "callback_query_id", "channel", "channel_policy"}, field_types={"tenant_id": str, "user_id": str, "goal": dict, "n": int, "model": str, "callback_query_id": str, "channel": str, "channel_policy": dict}),
        "growth_strategy_backlog@v1": _entry("growth_strategy_backlog@v1", 1, required={"tenant_id", "user_id"}, optional={"limit", "callback_query_id", "channel", "channel_policy"}, field_types={"tenant_id": str, "user_id": str, "limit": int, "callback_query_id": str, "channel": str, "channel_policy": dict}),
        "growth_strategy_accept@v1": _entry("growth_strategy_accept@v1", 1, required={"tenant_id", "user_id", "hypothesis_id"}, optional={"callback_query_id", "channel", "channel_policy"}, field_types={"tenant_id": str, "user_id": str, "hypothesis_id": str, "callback_query_id": str, "channel": str, "channel_policy": dict}),
        "growth_strategy_reject@v1": _entry("growth_strategy_reject@v1", 1, required={"tenant_id", "user_id", "hypothesis_id"}, optional={"callback_query_id", "channel", "channel_policy"}, field_types={"tenant_id": str, "user_id": str, "hypothesis_id": str, "callback_query_id": str, "channel": str, "channel_policy": dict}),
    }
