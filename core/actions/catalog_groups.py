...
def governance_catalog() -> dict[str, CatalogEntry]:
    return {
        ...
        "admin_user_card@v1": _entry("admin_user_card@v1", 1, required={"tenant_id", "admin_id", "target_user_id"}, optional=set(), field_types={"tenant_id": str, "admin_id": str, "target_user_id": str}),
        ...
        "apply_pricing_change@v1": _entry("apply_pricing_change@v1", 1, required={"tenant_id", "product_id", "admin_id", "new_price", "pricing_version"}, optional={"environment", "offer_id", "plan_id", "request_id", "reason", "requested_by"}, field_types={"tenant_id": str, "product_id": str, "admin_id": str, "environment": str, "offer_id": str, "plan_id": int, "new_price": int, "pricing_version": str, "request_id": str, "reason": str, "requested_by": str}),
        ...
        "reject_pricing_change@v1": _entry("reject_pricing_change@v1", 1, required={"tenant_id", "admin_id", "request_id"}, optional={"reason"}, field_types={"tenant_id": str, "admin_id": str, "request_id": str, "reason": str}),
