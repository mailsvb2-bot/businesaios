...
def governance_catalog() -> dict[str, CatalogEntry]:
    return {
        ...
        "suggest_offer_patch@v1": _entry("suggest_offer_patch@v1", 1, required={"tenant_id", "product", "env", "offer_id", "action"}, optional={"notify_user_id", "callback_query_id", "channel", "channel_policy"}, field_types={"tenant_id": str, "product": str, "env": str, "offer_id": str, "action": str, "notify_user_id": str, "callback_query_id": str, "channel": str, "channel_policy": dict}),
        "apply_offer_patch@v1": _entry("apply_offer_patch@v1", 1, required={"tenant_id", "product", "env", "offer_id"}, optional={"patch", "mode", "notify_user_id", "callback_query_id", "channel", "channel_policy"}, field_types={"tenant_id": str, "product": str, "env": str, "offer_id": str, "patch": dict, "mode": str, "notify_user_id": str, "callback_query_id": str, "channel": str, "channel_policy": dict}),
    }
