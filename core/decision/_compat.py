...
"""Helpers for thin legacy decision compatibility surfaces.

These helpers keep historical ``core.decision.*`` imports alive without
recreating owner logic in this namespace. Every compat module should bind to a
...
CANON_CORE_DECISION_COMPAT_HELPER = True


def install_compat_module(
    *,
    ...
    globals_dict['CANON_COMPAT_SHIM'] = True
    ...
    exports.update({'CANON_COMPAT_SHIM', 'CANONICAL_OWNER_MODULE'})
...
__all__ = ['CANON_CORE_DECISION_COMPAT_HELPER', 'install_compat_module']
