"""Dependency-neutral rollback workflow data contracts."""
...
CANON_SAFETY_ROLLBACK_CONTRACTS = True
...
class RollbackPlan:
    ...
    reconciliation_state: RollbackReconciliationState = (
...
__all__ = [
    "CANON_SAFETY_ROLLBACK_CONTRACTS",
    "RollbackAction",
