...
def _cta_submit_response(result) -> dict:
    return {
        ...
        'business_profile': dict(result.business_profile or {}),
        'selected_providers': list(result.selected_providers),
        'integration_plan': list(result.integration_plan),
        'autonomy_mode': result.autonomy_mode,
        'first_value_preview': dict(result.first_value_preview or {}),
        'onboarding_progress': dict(result.onboarding_progress or {}),
...
def _cta_status_response(status_payload) -> dict:
    ...
    return {
        ...
        'business_profile': dict(status_payload.business_profile or {}),
        'selected_providers': list(status_payload.selected_providers),
        'integration_plan': list(status_payload.integration_plan),
        'autonomy_mode': status_payload.autonomy_mode,
        'first_value_preview': dict(status_payload.first_value_preview or {}),
        'onboarding_progress': dict(status_payload.onboarding_progress or {}),
