...
_FINGERPRINT_EXCLUDED_METADATA_KEYS = frozenset({'approval_id','approval','approval_context','approval_policy','operator_override','operator_override_id','handoff','approvals','approval_completion_context'}) | _FINGERPRINT_TRANSIENT_KEYS
