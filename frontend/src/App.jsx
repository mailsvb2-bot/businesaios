    ...
    <main className="app-shell">
      ...
      <section className="workspace-grid">
        <article className="panel primary-panel">
          ...
          {!apiKey ? <div className="error-box" role="alert">Вход в кабинет завершился после перезагрузки страницы. Для безопасности данные доступа не сохраняются в браузере. Создайте новый кабинет, чтобы продолжить.</div> : null}
          {workspaceLoading ? <div className="loading-box">Открываем защищённый каталог…</div> : null}
          {workspaceError ? <div className="error-box" role="alert">{workspaceError}</div> : null}
