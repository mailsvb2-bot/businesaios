...
_CONNECTOR_CATALOG: Mapping[str, type[object]] = MappingProxyType({
...
def load_market_intelligence_connector_catalog() -> Mapping[str, type[object]]:
    return _CONNECTOR_CATALOG


__all__ = ['CANON_MARKET_INTELLIGENCE_BOOT', 'load_market_intelligence_connector_catalog']
