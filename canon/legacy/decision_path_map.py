...
CANONICAL_DECISION_PATH_SERVICES: Final[tuple[str, ...]] = (
    "decision_core",
    "governance_chain",
    "action_executor",
)

CANONICAL_STATE_FILES: Final[tuple[str, ...]] = (
    "application/world_state/world_state_assembler.py",
    "runtime/world_state/public_api.py",
    "bootstrap/world_model_contract.py",
)

SCAN_INCLUDE_PREFIXES: Final[tuple[str, ...]] = (
    "core/",
    "runtime/",
    "governance/",
    "canon/",
...
FORBIDDEN_DECISION_CLASS_NAMES: Final[tuple[str, ...]] = (
    "StrategyBrain",
    "GrowthBrain",
    "AutonomousBrain",
    "SecondDecisionCore",
...
FORBIDDEN_DECISION_METHOD_NAMES: Final[tuple[str, ...]] = (
    "decide_strategy",
    "issue_strategy",
    "emit_final_action",
    "select_final_action",
...
FORBIDDEN_SHADOW_STATE_NAMES: Final[tuple[str, ...]] = (
    "shadow_state",
    "shadow_world_model",
    "parallel_world_model",
    "duplicate_state",
...
DECISION_SURFACE_PREFIXES: Final[tuple[str, ...]] = (
    "core/ai/",
    "core/application/",
    "core/governance/",
    "runtime/execution/",
...
THIN_WRAPPER_HINTS: Final[tuple[str, ...]] = (
    "public_api",
    "compat",
    "wrapper",
    "facade",
...
ALLOWED_THIN_WRAPPER_CALLS: Final[tuple[str, ...]] = (
    "install_public_api_alias",
    "install_alias",
)

DUPLICATE_LOGIC_NAME_HINTS: Final[tuple[str, ...]] = (
    "decision",
    "router",
    "governance",
    "policy",
...
GOD_MODULE_ALLOWLIST_PREFIXES: Final[tuple[str, ...]] = (
    "contracts/",
    "tests/",
)

HIDDEN_LOGIC_ACTION_KEYS: Final[tuple[str, ...]] = (
    "selected_action",
    "final_action",
    "action_type",
    "best_action",
...
HIDDEN_LOGIC_RETURN_HINTS: Final[tuple[str, ...]] = (
    "decide",
    "select",
    "choose",
    "rank",
...
class LegacyCanonConfig:
    ...
    compatibility_modules: tuple[str, ...] = field(
    ...
    def is_excluded_relpath(self, relpath: str) -> bool:
        ...
        return normalized.startswith(self.excluded_prefixes)
    ...
    def is_decision_surface(self, relpath: str) -> bool:
        normalized = relpath.replace("\\", "/")
        return normalized.startswith(self.decision_surface_prefixes)

    def is_god_module_allowlisted(self, relpath: str) -> bool:
        normalized = relpath.replace("\\", "/")
        return normalized.startswith(self.god_module_allowlist_prefixes)
...
__all__ = [
    ...
    "CANONICAL_DECISION_CORE_PUBLIC_MODULE",
    "COMPAT_DECISION_ENGINE_MODULE",
    "CANONICAL_DECISION_PATH_SERVICES",
