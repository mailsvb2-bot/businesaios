...
BUSINESS_ONTOLOGY_OWNERSHIP_AUDIT = (
    ...
    _row(
        ...
        "ActionIntentV1 is the canonical non-effectful AI-to-execution entity contract. Full schema-versioned ActionIntent bodies persisted through the existing canonical EvidenceStore are the authoritative Action set and are projected read-only; older lineage-only Evidence rows are retained and counted explicitly as legacy history rather than reconstructed or promoted into canonical Action state.",
    ...
    _row(
        ...
        "storage.evidence_store",
        "BusinessOutcomeV1 is the canonical business Outcome entity contract. Full schema-versioned outcome bodies persisted through the existing canonical EvidenceStore are authoritative and projected read-only; older lineage-only Evidence rows remain retained and explicitly counted as legacy history rather than reconstructed or promoted into canonical Outcome state.",
        writers=("application.evidence.evidence_persistence",),
