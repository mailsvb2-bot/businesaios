...
class StagedRolloutPolicy:
    ...
    min_shadow_decisions: int = 1000
    min_production_outcomes: int = 100
    min_outcome_observations: int = 100
    max_disagreement_rate: float = 0.50
    max_critical_violations: int = 0
    max_average_cost_increase: float = 0.0
    max_average_regret: float = 0.0
