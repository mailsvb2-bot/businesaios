...
def evaluate_autonomy_transition(
    *,
    ...
    """Authorize both the sovereign decision intent and its executable projection.

    Capability planning may change the action used by the executor, but it may not
    downgrade the risk class of the DecisionCore intent before autonomy policy is
    applied. The more restrictive verdict always wins.
    """
