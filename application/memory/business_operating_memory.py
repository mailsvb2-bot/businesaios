...
def project_business_memory_evidence(
    ...
    *,
    ...
    return _project_business_memory_evidence_owner(payload, policy=policy)
...
def project_business_memory_summary(
    ...
    *,
    ...
    return _project_business_memory_summary_owner(payload, policy=policy)
...
def project_business_memory_governance_summary(
    ...
    *,
    ...
    return _project_business_memory_governance_summary_owner(payload, policy=policy)
...
def project_business_memory_profile(
    ...
    *,
    ...
    return _project_business_memory_profile_owner(payload, policy=policy)
...
def project_business_memory_recent_runs(
    ...
    *,
    ...
    return _project_business_memory_recent_runs_owner(payload, policy=policy, limit=limit)
...
def project_business_memory_patterns(
    ...
    *,
    ...
    return _project_business_memory_patterns_owner(payload, policy=policy)
...
def project_business_memory_state_context(
    ...
    *,
    ...
    return _project_business_memory_state_context_owner(payload, policy=policy)
...
def project_business_memory_feedback_snapshot(
    ...
    *,
    ...
    return _project_business_memory_feedback_snapshot_owner(payload, policy=policy)
...
def project_business_memory_contract_bundle(
    ...
    *,
    ...
    return _project_business_memory_contract_bundle_owner(
        payload,
        policy=policy,
...
def project_business_memory_meta_payloads(
    ...
    *,
    ...
    return _project_business_memory_meta_payloads_owner(
        payload,
        policy=policy,
        recent_runs_limit=recent_runs_limit,
    )
...
class FileBusinessOperatingMemoryStore:
    ...
    compactor: BusinessMemoryCompactor | None = None
