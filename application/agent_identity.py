...
from contracts.agent_identity import (
...
class AgentIdentityRegistry:
    """Single canonical AgentIdentity/delegation lifecycle writer over EventStore."""
        ...
        *,
        ...
        if current is not None:
            if self._payload(current) != payload:
                raise ValueError("agent identity already exists with different immutable authority")
...
__all__ = [
    ...
    "AgentIdentityHistoryInvariantViolation",
    "AgentIdentityNotFound",
    "AgentIdentityProjector",
