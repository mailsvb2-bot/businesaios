...
BASELINE_REQUIREMENTS: tuple[BaselineRequirement, ...] = (
    ...
    BaselineRequirement("BAIOS-BASE-010", "boot DecisionCore identity remains registered while runtime uses the explicit issuer", "decision-core", "tests/lock/test_decision_singleton_execution_path_lock.py::test_locked_path_uses_the_explicit_issuer_not_global_identity", ("fast", "full", "release", "pre-release")),
