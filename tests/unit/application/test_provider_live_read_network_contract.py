...
def test_only_proven_read_or_probe_providers_receive_live_network_binding() -> None:
    ...
    native = {'telegram_bot', 'whatsapp_cloud', 'hubspot', 'vk_messaging', 'max_messaging', 'slack_messaging', 'discord_messaging', 'instagram_messaging', 'messenger_messaging', 'line_messaging', 'viber_messaging'}
