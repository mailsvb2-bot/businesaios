...
def test_admin_route_handlers_expose_business_autonomy_overview() -> None:
    ...
    overview = handlers.get_business_autonomy_overview(business_id="sample_business")
    assert overview["business_id"] == "sample_business"
...
def test_admin_route_handlers_export_business_autonomy_bundle() -> None:
    handlers = AdminRouteHandlers()
    exported = handlers.export_business_autonomy_bundle(business_id="sample_business")
    assert exported["business_id"] == "sample_business"
