...
def test_expanded_legacy_safety_shadow_zones_do_not_embed_second_brain_tokens() -> None:
    offenders: list[str] = []
    ...
    assert not offenders, 'expanded legacy safety shadow-zones contain second-brain tokens:\n' + '\n'.join(offenders)
