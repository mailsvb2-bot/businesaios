...
class _LiveConnector:
    def __init__(self) -> None:
        self.provider = CrmProvider(
            ...
            capability_descriptor=CrmCapabilityDescriptor(provider_key='hubspot'),
        )
...
def test_live_oauth_flow_exchanges_code_and_marks_live_api() -> None:
    ...
    assert connector.exchanged == [
        ('secret://hubspot/live', 'code-123', 'https://example.com/cb')
    ]
