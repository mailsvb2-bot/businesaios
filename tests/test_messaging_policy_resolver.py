...
from runtime.messaging_policy.discipline import MessagingPolicyDisciplineViolation, ensure_policy_input_disciplined
...
def test_approval_preference_snapshot_is_not_a_public_policy_input() -> None:
    with pytest.raises(MessagingPolicyDisciplineViolation, match="preference_snapshot"):
        ensure_policy_input_disciplined({"preference_snapshot": {"primary": "telegram", "enabled": ["telegram"]}})
