...
def test_release_plans_include_postgres_contract_live_and_production_boot_before_release_artifacts() -> None:
    ...
    assert release_steps.index("postgres-contract") < release_steps.index("postgres-live") < release_steps.index("production-boot") < release_steps.index("verify-release")
    assert prerelease_steps.index("postgres-contract") < prerelease_steps.index("postgres-live") < prerelease_steps.index("production-boot") < prerelease_steps.index("verify-release")
