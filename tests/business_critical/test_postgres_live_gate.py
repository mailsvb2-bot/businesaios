...
def test_postgres_live_gate_is_registered_and_release_ordered() -> None:
    ...
    assert release_steps.index("postgres-contract") < release_steps.index("postgres-migrations") < release_steps.index("postgres-live") < release_steps.index("container-runtime") < release_steps.index("production-boot")
    assert prerelease_steps.index("postgres-contract") < prerelease_steps.index("postgres-migrations") < prerelease_steps.index("postgres-live") < prerelease_steps.index("container-runtime") < prerelease_steps.index("production-boot")
