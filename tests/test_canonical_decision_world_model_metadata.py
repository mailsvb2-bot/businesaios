...
def test_canonical_world_model_attaches_metadata():
    ...
    assert enriched.meta["pricing_world_model"] == "pricing-prod-1"
    assert enriched.meta["pricing_world_model_version"] == "2026-03-07"
    assert "pricing_world_model_hash" in enriched.meta
    assert enriched.meta["pricing_world_model_origin"] == "store"
