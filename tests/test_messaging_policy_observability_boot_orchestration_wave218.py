...
def test_boot_orchestration_with_all_dependencies_calls_every_expected_surface(monkeypatch):
    calls=[]
    ...
    assert calls == ['navigation','snapshot','traces','dashboard','alerts','alert_subscriptions','messaging_preferences']
    assert out.booted_keys == ('navigation','snapshot','traces','dashboard','alerts','alert_subscriptions','messaging_preferences')
