...
class CrmConnectionVerifier(CrmWriteVerifier):
    def build_request(self, *, provider_key: str, record_id: str | None, expected_fields: dict[str, object] | None = None) -> CrmVerificationRequest:
        return CrmVerificationRequest(entity_type='connection', provider_key=provider_key, record_id=record_id, expected_fields=expected_fields or {})
